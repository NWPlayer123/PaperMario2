...
//TODO: find way to have separate struct for Metadata/SaveFile vs block
...
typedef struct CardData {
	...
	CardSaveFile saves[4]; //0x2000 (+ 0x4000 * save_index)
} CardData;
...
typedef struct CardWork {
	...
	CardData* data; //0xA8
	CardSaveFile* currentSave; //0xAC, TODO rename readSave?
	CardSaveFile* tempSave; //0xB0, TODO rename writeSave?
